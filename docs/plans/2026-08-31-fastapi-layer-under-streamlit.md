...
`docs/requirements.md` Section 9a (added mid-V1, after a pass researching common
architecture patterns in the due-diligence/compliance-tech space) calls for a FastAPI REST layer sitting over the
