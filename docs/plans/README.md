...
| 2026-09-16 | [Phase 1 -- public-surface hotfix](2026-09-16-phase-1-public-surface-hotfix.md) | Built (B2-B4, S7, S8, S12, M16, S6-interim; full suite + `cli validate` green; the actual deploy to the live instance is still outstanding -- see the plan's Implementation note) |
