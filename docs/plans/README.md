...
| 2026-09-17 | [Phase 5 -- RPS hardening](2026-09-17-phase-5-rps-hardening.md) | Built (S9, S10, S11, M14, M15; M16's RPS half was already done in Phase 1, dropped from scope with a citation; full suite + `cli validate` green; demo-evidence diff confirmed empty, no `DEMO_FIXTURE_VERSION` bump needed; deploy still outstanding) |
