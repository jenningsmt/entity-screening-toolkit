...
*Next entries begin with the implementation plan for Use Case 01 — written by Claude Code against `docs/use-case-01-hb127-researcher-screening.md` and reviewed before any code, per the plan-first discipline established in Phase 2 for architecturally risky work.*
